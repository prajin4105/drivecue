    ...
    <div id="global-page-loader" style="position: fixed; inset: 0; background: #ffffff; display: flex; align-items: center; justify-content: center; z-index: 99999; opacity: 1; visibility: visible; transition: opacity 0.3s ease, visibility 0.3s ease;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
            ...
            <span style="font-size: 13.5px; font-weight: 800; color: #1E293B; font-family: inherit; margin-top: -6px; letter-spacing: -0.01em;"></span>
        </div>
    </div>
    <style>
        .loader {
    ...
    <script>
        (function() {
            ...
            // (Removed to prevent double-loader effect on route navigation)
            ...
            // document.addEventListener('click', function (e) { ... }); (Removed to prevent double-loader)
            ...
            document.addEventListener('livewire:navigating', function () {
                var requestStart = Date.now();
                showLoader();
                window.livewireRequestStart = requestStart;
            });
            document.addEventListener('livewire:navigated', function () {
                var start = window.livewireRequestStart || Date.now();
                hideLoaderWithDelay(start, 1000);
            });
        })();
    </script>
